...
!function (e) {
  ...
  function T(n, e, a, t) {
    ...
    function r(e, n) {
      ...
      if (
        "begin" == f.type && "end" == n.type && f.index == n.index && "" === t
      ) {
      ...
      if ("end" === n.type) {
        var r = function (e) {
          var n = e[0], t = i.substr(e.index), r = o(d, t);
          if (r) {
            var a = d;
            for (
              a.skip
    ...
    try {
      for (
        var b, h, N = 0; d.t.lastIndex = N, b = d.t.exec(i);
      ) {
  ...
  return a.highlight = T,
    ...
    a.C = a.COMMENT = function (e, n, t) {
      ...
      return r.c.push(a.PWM),
        r.c.push(
          { cN: "doctag", b: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0 },
        ),
        r;
    },
